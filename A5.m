...
for dir = 1:2
    ...
    a(currNode,currGrp,1,dir) = (phiR-phiL)/2; % Update a1
    a(currNode,currGrp,2,dir) = a0(currNode,currGrp)-(phiR+phiL)/2; % Update a2

    a(currNode,currGrp,3,dir) = (5*q(currNode,currGrp,1,dir)+3*q(currNode,currGrp,3,dir)-...
        5*a(currNode,currGrp,1,dir)*data.XSr(currComp,currGrp))/(3*(60*data.XSD(currComp,currGrp)+data.XSr(currComp,currGrp)));
    % Update a3
    a(currNode,currGrp,4,dir) = (-7*q(currNode,currGrp,2,dir)+3*q(currNode,currGrp,4,dir)+...
        7*a(currNode,currGrp,2,dir)*data.XSr(currComp,currGrp))/(3*(140*data.XSD(currComp,currGrp)+data.XSr(currComp,currGrp)));
    % Update a4
end
